...
// Command-line arguments: run --allow-external-contracts --allow-warnings --unicode-char false /Users/pari/pcc-llms/benchmark/dafny/CWE-22/cwe-22-safe.dfy --target cs --input /Users/pari/pcc-llms/stdlib/lib/FileIO.cs -- ./input.txt System.ArgumentException:
// cwe-22-safe.dfy
...
module {:options ""-functionSyntax:4""} FileIO {
  method {:extern ""DafnyLibraries.FileIO.Files"", ""INTERNAL_Open""} INTERNAL_Open(file: string)
  ...
  method {:extern ""DafnyLibraries.FileIO.Files"", ""INTERNAL_ReadBytesFromFile""} INTERNAL_ReadBytesFromFile(file: string)
      returns (isError: bool, bytesRead: seq<bv8>, errorMsg: string)
    decreases file

  method {:extern ""DafnyLibraries.FileIO.Files"", ""INTERNAL_WriteBytesToFile""} INTERNAL_WriteBytesToFile(file: string, bytes: seq<bv8>)
      returns (isError: bool, errorMsg: string)
    decreases file, bytes

  method {:extern ""DafnyLibraries.FileIO.Files"", ""INTERNAL_IsLink""} INTERNAL_IsLink(file: string)
      returns (isError: bool, isLink: bool, errorMsg: string)
    decreases file

  method {:extern ""DafnyLibraries.FileIO.Files"", ""INTERNAL_JoinPaths""} INTERNAL_JoinPaths(paths: seq<string>, separator: string)
...
module Utils {
  ...
  predicate is_valid_str_length(content: string)
    decreases content
  {
    -2147483648 <= |string_to_bytes(content)| < 2147483648
  }
...
namespace Utils {
  ...
  public partial class __default {
    ...
    public static bool is__valid__str__length(Dafny.ISequence<char> content) {
      return ((new BigInteger(-2147483648)) <= (new BigInteger((Utils.__default.string__to__bytes(content)).Count))) && ((new BigInteger((Utils.__default.string__to__bytes(content)).Count)) < (new BigInteger(2147483648L)));
    }
    ...
    public static Dafny.ISequence<byte> string__to__bytes(Dafny.ISequence<char> s) {
    ...
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)).Sign == 0) {
        ...
        _0___accumulator = Dafny.Sequence<byte>.Concat(_0___accumulator, Dafny.Sequence<byte>.FromElements(Utils.__default.char__to__byte((s).Select(BigInteger.Zero))));
...
namespace FileIO {
  ...
  public abstract class Error : _IError {
    ...
    private static readonly FileIO._IError theDefault = create_Noent();
    public static FileIO._IError Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<FileIO._IError> _TYPE = new Dafny.TypeDescriptor<FileIO._IError>(FileIO.Error.Default());
    public static Dafny.TypeDescriptor<FileIO._IError> _TypeDescriptor() {
      return _TYPE;
    }
  ...
  public class Error_Noent : Error {
    ...
    public override bool Equals(object other) {
      var oth = other as FileIO.Error_Noent;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class Error_Exist : Error {
    ...
    public override bool Equals(object other) {
      var oth = other as FileIO.Error_Exist;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public partial class Files {
    ...
    public Wrappers._IResult<object, Dafny.ISequence<char>> Open(Dafny.ISequence<char> file)
    {
      ...
      DafnyLibraries.FileIO.Files.INTERNAL_Open(file, out _out0, out _out1, out _out2);
      _0_isError = _out0;
      _1_fileStream = _out1;
      _2_errorMsg = _out2;
      if (_0_isError) {
    ...
    public Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> ReadBytesFromFile(Dafny.ISequence<char> file)
    {
      ...
      Dafny.ISequence<char> _out2;
      DafnyLibraries.FileIO.Files.INTERNAL_ReadBytesFromFile(file, out _out0, out _out1, out _out2);
      _0_isError = _out0;
      _1_bytesRead = _out1;
      _2_errorMsg = _out2;
      if (_0_isError) {
    ...
    public Wrappers._IResult<_System._ITuple0, Dafny.ISequence<char>> WriteBytesToFile(Dafny.ISequence<char> file, Dafny.ISequence<byte> bytes)
    {
      ...
      bool _out0;
      Dafny.ISequence<char> _out1;
      DafnyLibraries.FileIO.Files.INTERNAL_WriteBytesToFile(file, bytes, out _out0, out _out1);
      _0_isError = _out0;
      _1_errorMsg = _out1;
      if (_0_isError) {
    ...
    public Wrappers._IResult<bool, Dafny.ISequence<char>> IsLink(Dafny.ISequence<char> file)
    {
      ...
      bool _out1;
      Dafny.ISequence<char> _out2;
      DafnyLibraries.FileIO.Files.INTERNAL_IsLink(file, out _out0, out _out1, out _out2);
      _0_isError = _out0;
      _1_isLink = _out1;
      _2_errorMsg = _out2;
      if (_0_isError) {
    ...
    public Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> JoinPaths(Dafny.ISequence<Dafny.ISequence<char>> paths, Dafny.ISequence<char> separator)
    {
      ...
      Dafny.ISequence<char> _out1;
      Dafny.ISequence<char> _out2;
      DafnyLibraries.FileIO.Files.INTERNAL_JoinPaths(paths, separator, out _out0, out _out1, out _out2);
      _0_isError = _out0;
      _1_fullPath = _out1;
      _2_errorMsg = _out2;
      if (_0_isError) {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(8,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(9,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" FILE_PATH EXPECTED_ERROR_PREFIX")));}
      ...
      _2_baseDir = Dafny.Sequence<char>.FromString("/Users/pari/pcc-llms/benchmark/dafny/CWE-22/");
      FileIO.Files _3_f;
      FileIO.Files _nw0 = new FileIO.Files();
      _nw0.Init();
      _3_f = _nw0;
      Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> _4_joinRes;
      Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> _out0;
      _out0 = (_3_f).JoinPaths(Dafny.Sequence<Dafny.ISequence<char>>.FromElements(_2_baseDir, _0_filePath), Dafny.Sequence<char>.FromString("/"));
      _4_joinRes = _out0;
      if (!((_4_joinRes).is_Success)) {
        throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(16,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_4_joinRes).dtor_error));}
      Dafny.ISequence<char> _5_jointPath;
      _5_jointPath = ((System.Func<Dafny.ISequence<char>>) (() => {
        BigInteger dim0 = new BigInteger(((_4_joinRes).dtor_value).Count);
        var arr0 = new char[Dafny.Helpers.ToIntChecked(dim0, "array size exceeds memory limit")];
        for (int i0 = 0; i0 < dim0; i0++) {
          var _6_i = (BigInteger) i0;
          arr0[(int)(_6_i)] = ((_4_joinRes).dtor_value).Select(_6_i);
        }
        return Dafny.Sequence<char>.FromArray(arr0);
      }))();
      Dafny.ISequence<char> _7_expectedStr;
      _7_expectedStr = Dafny.Sequence<char>.FromString("Hello world\nGoodbye\n");
      Dafny.ISequence<BigInteger> _8_expectedBytes;
      _8_expectedBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
        BigInteger dim1 = new BigInteger((_7_expectedStr).Count);
        var arr1 = new BigInteger[Dafny.Helpers.ToIntChecked(dim1, "array size exceeds memory limit")];
        for (int i1 = 0; i1 < dim1; i1++) {
          var _9_i = (BigInteger) i1;
          arr1[(int)(_9_i)] = new BigInteger((_7_expectedStr).Select(_9_i));
        }
        return Dafny.Sequence<BigInteger>.FromArray(arr1);
      }))();
      if (((Utils.__default.non__empty__path(_5_jointPath)) && (Utils.__default.has__absolute__path(_5_jointPath))) && (!(Utils.__default.has__dangerous__pattern(_5_jointPath)))) {
        Wrappers._IResult<object, Dafny.ISequence<char>> _10_res;
        Wrappers._IResult<object, Dafny.ISequence<char>> _out1;
        _out1 = (_3_f).Open(_5_jointPath);
        _10_res = _out1;
        if (!((_10_res).is_Success)) {
          _5_jointPath = Dafny.Sequence<char>.FromString("");
          return ;
        } else {
          ...
          _out2 = (_3_f).ReadBytesFromFile(_5_jointPath);
          _11_readRes = _out2;
          if (!((_11_readRes).is_Success)) {
            throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(28,12): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_11_readRes).dtor_error));}
          if ((_11_readRes).is_Failure) {
            Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _12_readRes2;
            Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out3;
            _out3 = (_3_f).ReadBytesFromFile(Dafny.Sequence<char>.FromString(""));
            _12_readRes2 = _out3;
            if (!((_12_readRes2).is_Failure)) {
              throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(32,14): " + Dafny.Sequence<char>.FromString("unexpected success"));}
            if (!(Dafny.Sequence<char>.IsPrefixOf(_1_expectedErrorPrefix, (_12_readRes2).dtor_error))) {
              throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(33,14): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_12_readRes2).dtor_error));}
          } else {
            Dafny.ISequence<BigInteger> _13_readBytes;
            _13_readBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
              BigInteger dim2 = new BigInteger(((_11_readRes).dtor_value).Count);
              var arr2 = new BigInteger[Dafny.Helpers.ToIntChecked(dim2, "array size exceeds memory limit")];
              for (int i2 = 0; i2 < dim2; i2++) {
                var _14_i = (BigInteger) i2;
                arr2[(int)(_14_i)] = new BigInteger(((_11_readRes).dtor_value).Select(_14_i));
              }
              return Dafny.Sequence<BigInteger>.FromArray(arr2);
            }))();
            if (!((_13_readBytes).Equals(_8_expectedBytes))) {
              throw new Dafny.HaltException("benchmark/dafny/CWE-22/cwe-22-safe.dfy(36,14): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));}
          }
        }
      }
    }
