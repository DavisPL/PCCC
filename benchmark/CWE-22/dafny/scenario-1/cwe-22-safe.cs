// Dafny program cwe-22-safe.dfy compiled into C#
...
// Command-line arguments: run --allow-external-contracts --no-verify --allow-warnings --unicode-char false /Users/pari/pcc-llms/benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy --target cs --input /Users/pari/pcc-llms/stdlib/lib/Filesystem.cs -- /Users/pari/pcc-llms/benchmark/CWE-22/input.txt System.ArgumentException:
// cwe-22-safe.dfy
  ...
  decreases args
{
  ...
  var expectedBytes := seq(|expectedStr|, (i: int) requires 0 <= i < |expectedStr| => expectedStr[i] as Utils.byte);
  expect |expectedBytes| > 0, ""expectation violation"";
  expect |filePath| > 0, ""expectation violation"";
  if filePath == """" {
  ...
  if !utils.has_dangerous_pattern(filePath) && utils.non_empty_path(filePath) {
    ...
    if readRes.Failure? {
      ...
      var readBytes := seq(|readRes.value|, (i: int) requires 0 <= i < |readRes.value| => readRes.value[i] as Utils.byte);
...
module Utils {
  ...
  predicate has_dangerous_pattern(p: path)
    decreases p
  {
    contains_consecutive_periods(p) || !has_absolute_path(p) || contains_encoded_periods(p) || contains_dangerous_pattern(p)
  }
  ...
  predicate is_windows_absolute_path(p: path)
    ensures is_windows_absolute_path(p) == ((|p| >= 3 && is_drive_letter(p[0]) && p[1] == ':' && (p[2] == '\\' || p[2] == '/')) || (|p| == 2 && is_drive_letter(p[0]) && p[1] == ':') || (|p| >= 2 && p[0] == '\\' && p[1] == '\\'))
    decreases p
  {
  ...
  predicate is_valid_file_extension(filename: string)
    requires |filename| > 0
    ensures is_valid_file_extension(filename) ==> exists i: int {:trigger filename[i]} :: 0 <= i < |filename| && filename[i] == '.' && (forall j: int {:trigger filename[j]} :: (i < j < |filename| ==> filename[j] != '/') && (i < j < |filename| ==> filename[j] != '\\')) && i < |filename| - 1
    decreases filename
  {
  ...
  public partial class __default {
    ...
    public static bool is__valid__path__name(Dafny.ISequence<char> path) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<char>, bool>>((_0_path) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_path).Count)), true, (((_forall_var_0) => {
        BigInteger _1_i = (BigInteger)_forall_var_0;
        return !(((_1_i).Sign != -1) && ((_1_i) < (new BigInteger((_0_path).Count)))) || (Utils.__default.is__valid__path__char((_0_path).Select(_1_i)));
      }))))(path);
    }
    ...
    public static bool has__dangerous__pattern(Dafny.ISequence<char> p) {
      return (((Utils.__default.contains__consecutive__periods(p)) || (!(Utils.__default.has__absolute__path(p)))) || (Utils.__default.contains__encoded__periods(p))) || (Utils.__default.contains__dangerous__pattern(p));
    }
    ...
    public static bool is__canonical__path(Dafny.ISequence<char> p) {
      return true;
    }
    ...
    public static Dafny.ISequence<Dafny.ISequence<char>> sensitivePaths { get {
      return Dafny.Sequence<Dafny.ISequence<char>>.FromElements(Dafny.Sequence<char>.FromString("/id_rsa"), Dafny.Sequence<char>.FromString("/usr"), Dafny.Sequence<char>.FromString("/System"), Dafny.Sequence<char>.FromString("/bin"), Dafny.Sequence<char>.FromString("/sbin"), Dafny.Sequence<char>.FromString("/var"), Dafny.Sequence<char>.FromString("/usr/local"), Dafny.Sequence<char>.FromString("/documnets"), Dafny.Sequence<char>.FromString("/etc/passwd"));
    } }
  ...
  public partial class Files {
    ...
    public Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> JoinPaths(Dafny.ISequence<Dafny.ISequence<char>> paths, Dafny.ISequence<char> separator)
    {
      ...
      if (Utils.__default.has__dangerous__pattern(_0_combinedPath)) {
        res = Wrappers.Result<Dafny.ISequence<char>, Dafny.ISequence<char>>.create_Failure(Dafny.Sequence<char>.FromString("Resulting path contains dangerous patterns."));
        return res;
      }
      bool _2_isError;
      ...
      if (!(_3_fullPath).Equals(_0_combinedPath)) {
        _5_notValidPath = false;
      } else {
        _5_notValidPath = true;
      }
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(14,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(15,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" FILE_PATH EXPECTED_ERROR_PREFIX")));}
      Dafny.ISequence<char> _0_filePath;
      _0_filePath = (args).Select(BigInteger.One);
      Dafny.ISequence<char> _1_expectedErrorPrefix;
      _1_expectedErrorPrefix = (args).Select(new BigInteger(2));
      Dafny.ISequence<char> _2_expectedStr;
      _2_expectedStr = Dafny.Sequence<char>.FromString("Hello!\nThis is a safe text and you are allowed to read this content\n");
      Dafny.ISequence<byte> _3_expectedBytes;
      _3_expectedBytes = ((System.Func<Dafny.ISequence<byte>>) (() => {
        BigInteger dim1 = new BigInteger((_2_expectedStr).Count);
        var arr1 = new byte[Dafny.Helpers.ToIntChecked(dim1, "array size exceeds memory limit")];
        for (int i1 = 0; i1 < dim1; i1++) {
          var _4_i = (BigInteger) i1;
          arr1[(int)(_4_i)] = (byte)((_2_expectedStr).Select(_4_i));
        }
        return Dafny.Sequence<byte>.FromArray(arr1);
      }))();
      if (!((new BigInteger((_3_expectedBytes).Count)).Sign == 1)) {
        throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(20,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if (!((new BigInteger((_0_filePath).Count)).Sign == 1)) {
        throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(21,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if ((_0_filePath).Equals(Dafny.Sequence<char>.FromString(""))) {
        if (!(false)) {
          throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(23,6): " + Dafny.Sequence<char>.FromString("empty file path"));}
        return ;
      }
      if ((new BigInteger((_3_expectedBytes).Count)).Sign == 0) {
        if (!(false)) {
          throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(27,6): " + Dafny.Sequence<char>.FromString("empty byte sequence"));}
        return ;
      }
      Filesystem.Files _5_f;
      Filesystem.Files _nw0 = new Filesystem.Files();
      _nw0.Init(_0_filePath, _3_expectedBytes);
      _5_f = _nw0;
      Dafny.Helpers.Print((_System.Tuple2<Dafny.ISequence<char>, Dafny.ISequence<char>>.create(Dafny.Sequence<char>.FromString("file path: "), _0_filePath)));
      if ((!(Utils.__default.has__dangerous__pattern(_0_filePath))) && (Utils.__default.non__empty__path(_0_filePath))) {
        Wrappers._IResult<object, Dafny.ISequence<char>> _6_openRes;
        Wrappers._IResult<object, Dafny.ISequence<char>> _out0;
        _out0 = (_5_f).Open(_0_filePath);
        _6_openRes = _out0;
        if (!((_6_openRes).is_Success)) {
          throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(34,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error: "), (_6_openRes).dtor_error));}
        if ((_6_openRes).is_Failure) {
          if (!((_6_openRes).is_Success)) {
            throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(36,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error: "), (_6_openRes).dtor_error));}
          return ;
        }
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _7_readRes;
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out1;
        _out1 = (_5_f).ReadBytesFromFile(_0_filePath);
        _7_readRes = _out1;
        if ((_7_readRes).is_Failure) {
          if (!((_7_readRes).is_Success)) {
            throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(41,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_7_readRes).dtor_error));}
          Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _8_readResEmpty;
          Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out2;
          _out2 = (_5_f).ReadBytesFromFile(Dafny.Sequence<char>.FromString(""));
          _8_readResEmpty = _out2;
          if (!((_8_readResEmpty).is_Failure)) {
            throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(43,8): " + Dafny.Sequence<char>.FromString("unexpected success"));}
          if (!(Dafny.Sequence<char>.IsPrefixOf(_1_expectedErrorPrefix, (_8_readResEmpty).dtor_error))) {
            throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(44,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_8_readResEmpty).dtor_error));}
        } else {
          Dafny.ISequence<byte> _9_readBytes;
          _9_readBytes = ((System.Func<Dafny.ISequence<byte>>) (() => {
            BigInteger dim2 = new BigInteger(((_7_readRes).dtor_value).Count);
            var arr2 = new byte[Dafny.Helpers.ToIntChecked(dim2, "array size exceeds memory limit")];
            for (int i2 = 0; i2 < dim2; i2++) {
              var _10_i = (BigInteger) i2;
              arr2[(int)(_10_i)] = (byte)(((_7_readRes).dtor_value).Select(_10_i));
            }
            return Dafny.Sequence<byte>.FromArray(arr2);
          }))();
          if (!((_9_readBytes).Equals(_3_expectedBytes))) {
            throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(47,8): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));}
        }
        ...
        if (!(false)) {
          throw new Dafny.HaltException("benchmark/CWE-22/dafny/scenario-1/cwe-22-safe.dfy(52,8): " + Dafny.Sequence<char>.FromString("unsafe file path"));}
        return ;
      }
    }
  }
