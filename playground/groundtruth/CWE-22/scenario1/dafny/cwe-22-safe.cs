...
// Command-line arguments: run ./dafny/cwe-22-safe.dfy --allow-warnings --no-verify --unicode-char false --target cs --input /Users/pari/pcc-llms/FilesystemsAPI/std/FileIO.cs -- ./dafny/input.txt System.ArgumentException:
// cwe-22-safe.dfy
...
module Utils {
  ...
  {
    assert |s| == 0 || |s| > 0;
    assert forall i: int, _t#0: int {:trigger s[i], s[.._t#0]} {:trigger s[..i], s[.._t#0]} | _t#0 == i + 1 :: 0 <= i && i < |s| ==> s[.._t#0] == s[..i] + [s[i]];
  }
    ...
    decreases s, prefix
  {
    ...
    while i < |prefix|
      ...
      invariant forall k: int {:trigger prefix[k]} {:trigger s[k]} :: 0 <= k < i ==> s[k] == prefix[k]
      decreases |prefix| - i
    {
      if s[i] != prefix[i] {
        return false;
...
namespace Utils {
  ...
  public partial class __default {
    ...
    public static bool StartsWith(Dafny.ISequence<char> s, Dafny.ISequence<char> prefix)
    {
      ...
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) < (new BigInteger((prefix).Count))) {
        if (((s).Select(_0_i)) != ((prefix).Select(_0_i))) {
          result = false;
          return result;
        }
        _0_i = (_0_i) + (BigInteger.One);
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(7,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(8,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" FILE_PATH EXPECTED_ERROR_PREFIX")));}
      ...
      _1_expectedErrorPrefix = (args).Select(new BigInteger(2));
      {
        ...
        _2_baseDir = Dafny.Sequence<char>.FromString("/Users/pari/pcc-llms/dataset/cwe-list/CWE-22");
        Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> _3_joinRes;
        Wrappers._IResult<Dafny.ISequence<char>, Dafny.ISequence<char>> _out0;
        _out0 = FileIO.__default.JoinPaths(Dafny.Sequence<Dafny.ISequence<char>>.FromElements(_2_baseDir, _0_filePath), Dafny.Sequence<char>.FromString("/"));
        _3_joinRes = _out0;
        if (!((_3_joinRes).is_Success)) {
          throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(16,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_3_joinRes).dtor_error));}
        Dafny.ISequence<char> _4_jointPath;
        _4_jointPath = ((System.Func<Dafny.ISequence<char>>) (() => {
          BigInteger dim0 = new BigInteger(((_3_joinRes).dtor_value).Count);
          var arr0 = new char[Dafny.Helpers.ToIntChecked(dim0, "array size exceeds memory limit")];
          for (int i0 = 0; i0 < dim0; i0++) {
            var _5_i = (BigInteger) i0;
            arr0[(int)(_5_i)] = ((_3_joinRes).dtor_value).Select(_5_i);
          }
          return Dafny.Sequence<char>.FromArray(arr0);
        }))();
        Dafny.ISequence<char> _6_expectedStr;
        _6_expectedStr = Dafny.Sequence<char>.FromString("Hello world\nGoodbye\n");
        Dafny.ISequence<BigInteger> _7_expectedBytes;
        _7_expectedBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim1 = new BigInteger((_6_expectedStr).Count);
          var arr1 = new BigInteger[Dafny.Helpers.ToIntChecked(dim1, "array size exceeds memory limit")];
          for (int i1 = 0; i1 < dim1; i1++) {
            var _8_i = (BigInteger) i1;
            arr1[(int)(_8_i)] = new BigInteger((_6_expectedStr).Select(_8_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr1);
        }))();
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _9_res;
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out1;
        _out1 = FileIO.__default.ReadBytesFromFile(_4_jointPath);
        _9_res = _out1;
        if (!((_9_res).is_Success)) {
          throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(24,8): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_9_res).dtor_error));}
        Dafny.ISequence<BigInteger> _10_readBytes;
        _10_readBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim2 = new BigInteger(((_9_res).dtor_value).Count);
          var arr2 = new BigInteger[Dafny.Helpers.ToIntChecked(dim2, "array size exceeds memory limit")];
          for (int i2 = 0; i2 < dim2; i2++) {
            var _11_i = (BigInteger) i2;
            arr2[(int)(_11_i)] = new BigInteger(((_9_res).dtor_value).Select(_11_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr2);
        }))();
        if (!((_10_readBytes).Equals(_7_expectedBytes))) {
          throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(27,8): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));}
      }
      {
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _12_res;
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out2;
        _out2 = FileIO.__default.ReadBytesFromFile(Dafny.Sequence<char>.FromString(""));
        _12_res = _out2;
        if (!((_12_res).is_Failure)) {
          throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(33,6): " + Dafny.Sequence<char>.FromString("unexpected success"));}
        if (!(Dafny.Sequence<char>.IsPrefixOf(_1_expectedErrorPrefix, (_12_res).dtor_error))) {
          throw new Dafny.HaltException("dafny/cwe-22-safe.dfy(34,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_12_res).dtor_error));}
      }
    }
  }
