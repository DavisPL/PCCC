...
def create_few_shot_code_prompts(examples_task_ids, examples_db, prompt_template):
    ...
    formatted_examples = [format_example(ex, prompt_template) for ex in examples]
...
def create_few_shot_specification_prompts(examples_task_ids, examples_db, prompt_template):
    ...
    combined_examples = example_separator.join(formatted_examples)
    final_prompt_template = combined_examples + suffix
...
def parse_specification_output(response_text):
    response_schemas = [
