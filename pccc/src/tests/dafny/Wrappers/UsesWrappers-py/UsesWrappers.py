...
class default__:
    ...
    def SafeDiv(a, b):
        if (b) == (0):
            ...
            return Std_Wrappers.Option_Some(_dafny.euclidian_division(a, b))

    @staticmethod
    def Main(noArgsParameter__):
        _dafny.print(_dafny.string_of(default__.SafeDiv(4, 2)))
        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
        _dafny.print(_dafny.string_of(default__.SafeDiv(7, 0)))
        _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "\n"))).VerbatimString(False))
