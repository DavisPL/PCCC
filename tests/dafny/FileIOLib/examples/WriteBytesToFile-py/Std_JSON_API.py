...
class default__:
    ...
    @staticmethod
    def Serialize(js):
        d_800_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_800_valueOrError0_).IsFailure():
            return (d_800_valueOrError0_).PropagateFailure()
        elif True:
            d_801_js_ = (d_800_valueOrError0_).Extract()
            return Std_JSON_ZeroCopy_API.default__.Serialize(d_801_js_)

    @staticmethod
    def SerializeAlloc(js):
        bs: Std_Wrappers.Result = Std_Wrappers.Result.default(_dafny.defaults.pointer)()
        d_802_js_: Std_JSON_Grammar.Structural
        d_803_valueOrError0_: Std_Wrappers.Result = Std_Wrappers.Result.default(Std_JSON_Grammar.Structural.default(Std_JSON_Grammar.Value.default()))()
        d_803_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_803_valueOrError0_).IsFailure():
            bs = (d_803_valueOrError0_).PropagateFailure()
            return bs
        d_802_js_ = (d_803_valueOrError0_).Extract()
        out11_: Std_Wrappers.Result
        out11_ = Std_JSON_ZeroCopy_API.default__.SerializeAlloc(d_802_js_)
        bs = out11_
        return bs
    ...
    def SerializeInto(js, bs):
        ...
        d_804_js_: Std_JSON_Grammar.Structural
        d_805_valueOrError0_: Std_Wrappers.Result = Std_Wrappers.Result.default(Std_JSON_Grammar.Structural.default(Std_JSON_Grammar.Value.default()))()
        d_805_valueOrError0_ = Std_JSON_Serializer.default__.JSON(js)
        if (d_805_valueOrError0_).IsFailure():
            len = (d_805_valueOrError0_).PropagateFailure()
            return len
        d_804_js_ = (d_805_valueOrError0_).Extract()
        out12_: Std_Wrappers.Result
        out12_ = Std_JSON_ZeroCopy_API.default__.SerializeInto(d_804_js_, bs)
        len = out12_
        return len

    @staticmethod
    def Deserialize(bs):
        d_806_valueOrError0_ = Std_JSON_ZeroCopy_API.default__.Deserialize(bs)
        if (d_806_valueOrError0_).IsFailure():
            return (d_806_valueOrError0_).PropagateFailure()
        elif True:
            d_807_js_ = (d_806_valueOrError0_).Extract()
            return Std_JSON_Deserializer.default__.JSON(d_807_js_)
