...
class uint128:
    ...
    def _Is(source__):
        ...
        return ((0) <= (d_33_x_)) and ((d_33_x_) < (default__.TWO__TO__THE__128))
...
class int128:
    ...
    def _Is(source__):
        ...
        return (((0) - (default__.TWO__TO__THE__127)) <= (d_34_x_)) and ((d_34_x_) < (default__.TWO__TO__THE__127))
...
class nat8:
    ...
    def _Is(source__):
        ...
        return ((0) <= (d_35_x_)) and ((d_35_x_) < (default__.TWO__TO__THE__7))
...
class nat16:
    ...
    def _Is(source__):
        ...
        return ((0) <= (d_36_x_)) and ((d_36_x_) < (default__.TWO__TO__THE__15))
...
class nat32:
    ...
    def default():
        return int(0)
    def _Is(source__):
        d_37_x_: int = source__
        return ((0) <= (d_37_x_)) and ((d_37_x_) < (default__.TWO__TO__THE__31))
...
class nat64:
    ...
    def _Is(source__):
        ...
        return ((0) <= (d_38_x_)) and ((d_38_x_) < (default__.TWO__TO__THE__63))
...
class nat128:
    ...
    def _Is(source__):
        ...
        return ((0) <= (d_39_x_)) and ((d_39_x_) < (default__.TWO__TO__THE__127))
...
class opt__byte:
    ...
    def default():
        return int(0)
    def _Is(source__):
        d_40_c_: int = source__
        return ((-1) <= (d_40_c_)) and ((d_40_c_) < (default__.TWO__TO__THE__8))
