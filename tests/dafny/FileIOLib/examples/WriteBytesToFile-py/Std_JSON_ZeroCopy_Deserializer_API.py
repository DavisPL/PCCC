...
class default__:
    ...
    def LiftCursorError(err):
        ...
        if source24_.is_EOF:
            ...
            d_785___mcc_h0_ = source24_.expected
            d_786___mcc_h1_ = source24_.b
            d_787_b_ = d_786___mcc_h1_
            d_788_expected_ = d_785___mcc_h0_
            return Std_JSON_Errors.DeserializationError_ExpectingByte(d_788_expected_, d_787_b_)
        elif source24_.is_ExpectingAnyByte:
            d_789___mcc_h2_ = source24_.expected__sq
            d_790___mcc_h3_ = source24_.b
            d_791_b_ = d_790___mcc_h3_
            d_792_expected__sq_ = d_789___mcc_h2_
            return Std_JSON_Errors.DeserializationError_ExpectingAnyByte(d_792_expected__sq_, d_791_b_)
        elif True:
            d_793___mcc_h4_ = source24_.err
            d_794_err_ = d_793___mcc_h4_
            return d_794_err_
    ...
    @staticmethod
    def Text(v):
        d_795_valueOrError0_ = default__.JSON(Std_JSON_Utils_Cursors.Cursor__.OfView(v))
        if (d_795_valueOrError0_).IsFailure():
            return (d_795_valueOrError0_).PropagateFailure()
        elif True:
            let_tmp_rhs39_ = (d_795_valueOrError0_).Extract()
            d_796_text_ = let_tmp_rhs39_.t
            d_797_cs_ = let_tmp_rhs39_.cs
            d_798_valueOrError1_ = Std_Wrappers.default__.Need((d_797_cs_).EOF_q, Std_JSON_Errors.DeserializationError_ExpectingEOF())
            if (d_798_valueOrError1_).IsFailure():
                return (d_798_valueOrError1_).PropagateFailure()
            elif True:
                return Std_Wrappers.Result_Success(d_796_text_)

    @staticmethod
    def OfBytes(bs):
        d_799_valueOrError0_ = Std_Wrappers.default__.Need((len(bs)) < (Std_BoundedInts.default__.TWO__TO__THE__32), Std_JSON_Errors.DeserializationError_IntOverflow())
        if (d_799_valueOrError0_).IsFailure():
            return (d_799_valueOrError0_).PropagateFailure()
        elif True:
