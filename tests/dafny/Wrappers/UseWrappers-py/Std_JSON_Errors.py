...
class DeserializationError:
    ...
    def ToString(self):
        ...
        if source10_.is_UnterminatedSequence:
            ...
            d_309___mcc_h0_ = source10_.str
            d_310_str_ = d_309___mcc_h0_
            return (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Unsupported escape sequence: "))) + (d_310_str_)
            ...
            d_311___mcc_h1_ = source10_.expected
            d_312___mcc_h2_ = source10_.b
            d_313_b_ = d_312___mcc_h2_
            d_314_b0_ = d_311___mcc_h1_
            d_315_c_ = (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "'"))) + (_dafny.SeqWithoutIsStrInference([_dafny.CodePoint(chr(d_313_b_))]))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "'"))) if (d_313_b_) > (0) else _dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "EOF")))
            return (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Expecting '"))) + (_dafny.SeqWithoutIsStrInference([_dafny.CodePoint(chr(d_314_b0_))]))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "', read ")))) + (d_315_c_)
        elif source10_.is_ExpectingAnyByte:
            d_316___mcc_h3_ = source10_.expected__sq
            d_317___mcc_h4_ = source10_.b
            d_318_b_ = d_317___mcc_h4_
            d_319_bs0_ = d_316___mcc_h3_
            d_320_c_ = (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "'"))) + (_dafny.SeqWithoutIsStrInference([_dafny.CodePoint(chr(d_318_b_))]))) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "'"))) if (d_318_b_) > (0) else _dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "EOF")))
            d_321_c0s_ = _dafny.SeqWithoutIsStrInference([_dafny.CodePoint(chr((d_319_bs0_)[d_322_idx_])) for d_322_idx_ in range(len(d_319_bs0_))])
            return (((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Expecting one of '"))) + (d_321_c0s_)) + (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "', read ")))) + (d_320_c_)
        elif True:
...
class SerializationError:
    ...
    def ToString(self):
        ...
        if source11_.is_OutOfMemory:
            ...
            d_323___mcc_h0_ = source11_.i
            d_324_i_ = d_323___mcc_h0_
            return (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Integer too large: "))) + (Std_Strings.default__.OfInt(d_324_i_))
        elif source11_.is_StringTooLong:
            d_325___mcc_h1_ = source11_.s
            d_326_s_ = d_325___mcc_h1_
            return (_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "String too long: "))) + (d_326_s_)
        elif True:
            return _dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Invalid Unicode sequence"))
