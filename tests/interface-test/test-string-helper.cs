// Dafny program test-string-helper.dfy compiled into C#
...
// Command-line arguments: run /Users/pari/pcc-llms/tests/interface-test/test-string-helper.dfy
// test-string-helper.dfy
...
module Utils {
  ...
  const sensitiveFiles := [""/etc/passwd"", ""/etc/shadow"", ""/etc/hosts"", ""C:\\Windows\\System32\\config\\SAM"", ""C:\\Windows\\System32\\drivers\\etc\\hosts"", "".ssh/id_rsa"", "".ssh/id_rsa.pub"", ""C:\\ProgramData\\Microsoft\\Windows\\Start Menu""]
  ...
  predicate has_dangerous_pattern(p: path)
    decreases p
  {
    contains_consecutive_periods(p) || contains_encoded_periods(p) || contains_dangerous_pattern(p) || has_dot_dot_slash(p) || has_dot_dot_backslash(p) || has_slash_dot_dot(p) || has_backslash_dot_dot(p)
  }

  predicate has_relative_traversal_pattern(p: path)
    decreases p
  {
    has_parent_dir_traversal(p) || has_dot_dot_slash(p) || has_dot_dot_backslash(p) || has_slash_dot_dot(p) || has_backslash_dot_dot(p)
  }
  ...
  function is_abs_path(p: path): bool
    decreases p
  {
    if get_sep(p) == ""/"" then
      ...
      is_windows_abs_path(p) && !contains_consecutive_periods(p)
  }
  ...
  method get_file_extension(f: file) returns (extension: string)
    ensures extension != """" <==> exists i: int {:trigger f[i]} :: 0 <= i < |f| && i + 1 < |f| && f[i] == '.' && f[i + 1..] == extension
    decreases f
  {
    extension := """";
  ...
  predicate contains_dangerous_pattern(s: seq<char>)
    decreases s
  {
    has_parent_dir_traversal(s) || has_home_dir_reference(s) || contains_drive_letter(s)
  }
  ...
  method LastCharIndex(s: string, c: char) returns (idx: int)
    ensures -1 <= idx < |s|
    ensures idx == -1 ==> forall i: int {:trigger s[i]} :: 0 <= i < |s| ==> s[i] != c
    ensures 0 <= idx < |s| ==> s[idx] == c
    ensures idx != -1 ==> forall i: int {:trigger s[i]} :: idx < i < |s| ==> s[i] != c
    decreases s, c
  {
    idx := -1;
    var i := |s| - 1;
    while i >= 0
      invariant -1 <= i < |s|
      invariant idx != -1 ==> s[idx] == c && forall i: int {:trigger s[i]} :: idx < i < |s| ==> s[i] != c
      invariant idx == -1 ==> forall j: int {:trigger s[j]} :: i < j < |s| ==> s[j] != c
      decreases i
    {
      if s[i] == c {
        idx := i;
...
namespace Utils {
  ...
  public partial class __default {
    public static bool alpha__numeric(Dafny.Rune c) {
      return ((((c) >= (new Dafny.Rune('A'))) && ((c) <= (new Dafny.Rune('Z')))) || (((c) >= (new Dafny.Rune('a'))) && ((c) <= (new Dafny.Rune('z'))))) || (((c) >= (new Dafny.Rune('0'))) && ((c) <= (new Dafny.Rune('9'))));
    }
    public static bool is__alpha__numeric(Dafny.ISequence<Dafny.Rune> s) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_s) => Dafny.Helpers.Quantifier<Dafny.Rune>((_0_s).UniqueElements, true, (((_forall_var_0) => {
        Dafny.Rune _1_c = (Dafny.Rune)_forall_var_0;
        return !((_0_s).Contains(_1_c)) || (Utils.__default.alpha__numeric(_1_c));
      }))))(s);
    }
    public static bool is__drive__letter(Dafny.Rune c) {
      return (((new Dafny.Rune('a')) <= (c)) && ((c) <= (new Dafny.Rune('z')))) || (((new Dafny.Rune('A')) <= (c)) && ((c) <= (new Dafny.Rune('Z'))));
    }
    public static Dafny.ISequence<BigInteger> string__to__int(Dafny.ISequence<Dafny.Rune> c) {
      if ((new BigInteger((c).Count)).Sign == 0) {
        ...
        return ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          ...
          for (int i0 = 0; i0 < dim0; i0++) {
            ...
            arr0[(int)(_0_i)] = new BigInteger(((c).Select(_0_i)).Value);
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr0);
        }))();
      }
    }
    public static bool is__valid__char(Dafny.Rune c) {
      return (Utils.__default.alpha__numeric(c)) || ((Utils.__default.validPathCharacters).Contains(c));
    }
    public static bool is__file__valid__char(Dafny.Rune c) {
      return (Utils.__default.alpha__numeric(c)) || ((Utils.__default.validFileCharacters).Contains(c));
    }
    public static bool is__valid__file__name(Dafny.ISequence<Dafny.Rune> filename) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_filename) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_filename).Count)), true, (((_forall_var_0) => {
    ...
    public static bool is__valid__path__char(Dafny.Rune c) {
      return (Utils.__default.alpha__numeric(c)) || ((Utils.__default.validPathCharacters).Contains(c));
    }
    public static bool is__valid__path__name(Dafny.ISequence<Dafny.Rune> path) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_path) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_path).Count)), true, (((_forall_var_0) => {
        BigInteger _1_i = (BigInteger)_forall_var_0;
        return !(((_1_i).Sign != -1) && ((_1_i) < (new BigInteger((_0_path).Count)))) || (Utils.__default.is__valid__char((_0_path).Select(_1_i)));
      }))))(path);
    }
    public static bool is__valid__content__str(Dafny.ISequence<Dafny.Rune> s) {
    ...
    public static bool has__valid__file__length(Dafny.ISequence<Dafny.Rune> f) {
      return ((new BigInteger((f).Count)).Sign == 1) && ((new BigInteger((f).Count)) < (Utils.__default.fileMaxLength));
    }
    public static bool is__valid__str__length(Dafny.ISequence<Dafny.Rune> content) {
    ...
    public static bool is__valid__dir__char(Dafny.Rune c) {
      return (Utils.__default.alpha__numeric(c)) || ((Utils.__default.validPathCharacters).Contains(c));
    }
    public static bool is__valid__dir(Dafny.ISequence<Dafny.Rune> p) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<Dafny.Rune>, bool>>((_0_p) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_p).Count)), true, (((_forall_var_0) => {
        BigInteger _1_i = (BigInteger)_forall_var_0;
        return !(((_1_i).Sign != -1) && ((_1_i) < (new BigInteger((_0_p).Count)))) || (Utils.__default.is__valid__char((_0_p).Select(_1_i)));
      }))))(p);
    }
    public static bool has__valid__path__length(Dafny.ISequence<Dafny.Rune> p) {
      return ((new BigInteger((p).Count)).Sign != -1) && ((new BigInteger((p).Count)) < (Utils.__default.pathMaxLength));
    }
    public static bool non__empty__path(Dafny.ISequence<Dafny.Rune> f) {
      return (!(f).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) && ((new BigInteger((f).Count)).Sign == 1);
    }
    public static bool no__leading__trailing__space(Dafny.ISequence<Dafny.Rune> filename) {
      return (((filename).Select(BigInteger.Zero)) != (new Dafny.Rune(' '))) && (((filename).Select((new BigInteger((filename).Count)) - (BigInteger.One))) != (new Dafny.Rune(' ')));
    }
    public static bool no__period__at__start(Dafny.ISequence<Dafny.Rune> filename) {
      return ((filename).Select(BigInteger.Zero)) != (new Dafny.Rune('.'));
    }
    public static Dafny.ISequence<Dafny.Rune> string__slice(Dafny.ISequence<Dafny.Rune> s) {
    ...
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)).Sign == 0) {
        ...
        _0___accumulator = Dafny.Sequence<Dafny.Rune>.Concat(_0___accumulator, Dafny.Sequence<Dafny.Rune>.FromElements((s).Select((new BigInteger((s).Count)) - (BigInteger.One))));
        Dafny.ISequence<Dafny.Rune> _in0 = (s).Take((new BigInteger((s).Count)) - (BigInteger.One));
        s = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.ISequence<Dafny.Rune> concat(Dafny.ISequence<Dafny.Rune> s1, Dafny.ISequence<Dafny.Rune> s2)
    {
      return Dafny.Sequence<Dafny.Rune>.Concat(s1, s2);
    }
    public static bool joint__path__length(Dafny.ISequence<Dafny.Rune> p, Dafny.ISequence<Dafny.Rune> f)
    {
    ...
    public static Dafny.ISequence<Dafny.Rune> append__file__to__path(Dafny.ISequence<Dafny.Rune> p, Dafny.ISequence<Dafny.Rune> f)
    {
      if ((new BigInteger((p).Count)).Sign == 0) {
        return f;
      } else if (((p).Select((new BigInteger((p).Count)) - (BigInteger.One))) == (new Dafny.Rune('/'))) {
        return Utils.__default.concat(p, f);
      } else {
        return Utils.__default.concat(Utils.__default.concat(p, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/")), f);
      }
    }
    public static BigInteger get__path__length(Utils._IPathOrFile pof) {
      ...
      {
        if (_source0.is_Path) {
          Dafny.ISequence<Dafny.Rune> _0_p = _source0.dtor_p;
          return new BigInteger((_0_p).Count);
        }
      }
      {
        Dafny.ISequence<Dafny.Rune> _1_f = _source0.dtor_f;
        return new BigInteger((_1_f).Count);
      }
    }
    public static bool has__dangerous__pattern(Dafny.ISequence<Dafny.Rune> p) {
      return ((((((Utils.__default.contains__consecutive__periods(p)) || (Utils.__default.contains__encoded__periods(p))) || (Utils.__default.contains__dangerous__pattern(p))) || (Utils.__default.has__dot__dot__slash(p))) || (Utils.__default.has__dot__dot__backslash(p))) || (Utils.__default.has__slash__dot__dot(p))) || (Utils.__default.has__backslash__dot__dot(p));
    }
    public static bool has__relative__traversal__pattern(Dafny.ISequence<Dafny.Rune> p) {
      return ((((Utils.__default.has__parent__dir__traversal(p)) || (Utils.__default.has__dot__dot__slash(p))) || (Utils.__default.has__dot__dot__backslash(p))) || (Utils.__default.has__slash__dot__dot(p))) || (Utils.__default.has__backslash__dot__dot(p));
    }
    public static Dafny.ISequence<Dafny.Rune> get__sep(Dafny.ISequence<Dafny.Rune> p) {
      if ((p).Contains(new Dafny.Rune('/'))) {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/");
      } else {
        return Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\\");
      }
    }
    public static bool is__abs__path(Dafny.ISequence<Dafny.Rune> p) {
      if ((Utils.__default.get__sep(p)).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/"))) {
        return (Utils.__default.is__unix__absolute__path(p)) && (!(Utils.__default.contains__consecutive__periods(p)));
      } else {
        return (Utils.__default.is__windows__abs__path(p)) && (!(Utils.__default.contains__consecutive__periods(p)));
      }
    }
    public static bool ContainsAbsolutePaths(Dafny.ISequence<Dafny.Rune> p)
    {
      bool contains = false;
      contains = Utils.__default.is__abs__path(p);
      return contains;
    }
    public static bool is__unix__absolute__path(Dafny.ISequence<Dafny.Rune> p) {
      return ((new BigInteger((p).Count)).Sign == 1) && (((p).Select(BigInteger.Zero)) == (new Dafny.Rune('/')));
    }
    public static bool is__windows__abs__path(Dafny.ISequence<Dafny.Rune> p) {
      bool _0_isDrivePathWithSlash = ((((new BigInteger((p).Count)) >= (new BigInteger(3))) && (Utils.__default.is__drive__letter((p).Select(BigInteger.Zero)))) && (((p).Select(BigInteger.One)) == (new Dafny.Rune(':')))) && ((((p).Select(new BigInteger(2))) == (new Dafny.Rune('\\'))) || (((p).Select(new BigInteger(2))) == (new Dafny.Rune('/'))));
      bool _1_isDrivePath = (((new BigInteger((p).Count)) == (new BigInteger(2))) && (Utils.__default.is__drive__letter((p).Select(BigInteger.Zero)))) && (((p).Select(BigInteger.One)) == (new Dafny.Rune(':')));
      bool _2_isUNCPath = (((new BigInteger((p).Count)) >= (new BigInteger(2))) && (((p).Select(BigInteger.Zero)) == (new Dafny.Rune('\\')))) && (((p).Select(BigInteger.One)) == (new Dafny.Rune('\\')));
      return ((_0_isDrivePathWithSlash) || (_1_isDrivePath)) || (_2_isUNCPath);
    }
    public static bool is__abs(Dafny.ISequence<Dafny.Rune> p) {
      return (Utils.__default.is__unix__absolute__path(p)) || (Utils.__default.is__windows__abs__path(p));
    }
    public static Dafny.ISequence<Dafny.Rune> get__file__extension(Dafny.ISequence<Dafny.Rune> f)
    {
      Dafny.ISequence<Dafny.Rune> extension = Dafny.Sequence<Dafny.Rune>.Empty;
      extension = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("");
      BigInteger _0_lastDotIndex;
      BigInteger _out0;
      _out0 = Utils.__default.LastCharIndex(f, new Dafny.Rune('.'));
      _0_lastDotIndex = _out0;
      if ((_0_lastDotIndex) == (new BigInteger(-1))) {
        return extension;
      }
      extension = (f).Drop((_0_lastDotIndex) + (BigInteger.One));
      return extension;
    }
    public static bool ValidateFileType(Dafny.ISequence<Dafny.Rune> t)
    {
      bool result = false;
      bool _0_res;
      bool _out0;
      _out0 = Utils.__default.ContainsSequence(Utils.__default.restrictedDirs, t);
      _0_res = _out0;
      result = !(_0_res);
      return result;
    }
    public static bool NonSensitiveFilePath(Dafny.ISequence<Dafny.Rune> t)
    {
      bool result = false;
      bool _0_res;
      bool _out0;
    ...
    public static bool ContainsC(Dafny.ISequence<Dafny.Rune> s, Dafny.Rune c)
    {
      bool result = false;
      result = false;
      BigInteger _0_i;
    ...
    public static bool is__prefix(Dafny.ISequence<Dafny.Rune> p1, Dafny.ISequence<Dafny.Rune> p2)
    {
      return ((new BigInteger((p1).Count)) <= (new BigInteger((p2).Count))) && ((p1).Equals((p2).Take(new BigInteger((p1).Count))));
    }
    public static bool ContainsSequence(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> list, Dafny.ISequence<Dafny.Rune> sub)
    {
      bool result = false;
      result = false;
    ...
    public static bool is__lower__case(Dafny.Rune c) {
      return ((new BigInteger(97)) <= (new BigInteger((c).Value))) && ((new BigInteger((c).Value)) <= (new BigInteger(122)));
    }
    public static bool is__lower__upper__pair(Dafny.Rune c, Dafny.Rune C)
    {
      return (new BigInteger((c).Value)) == ((new BigInteger((C).Value)) + (new BigInteger(32)));
    }
    public static Dafny.Rune shift__minus32(Dafny.Rune c) {
      return new Dafny.Rune((int)(Dafny.Helpers.EuclideanModulus((new BigInteger((c).Value)) - (new BigInteger(32)), new BigInteger(128))));
    }
    public static Dafny.ISequence<Dafny.Rune> ToUppercase(Dafny.ISequence<Dafny.Rune> s)
    {
      Dafny.ISequence<Dafny.Rune> v = Dafny.Sequence<Dafny.Rune>.Empty;
      Dafny.ISequence<Dafny.Rune> _0_s_k;
      _0_s_k = Dafny.Sequence<Dafny.Rune>.FromElements();
      ...
      for (BigInteger _1_i = BigInteger.Zero; _1_i < _hi0; _1_i++) {
        if (Utils.__default.is__lower__case((s).Select(_1_i))) {
          _0_s_k = Dafny.Sequence<Dafny.Rune>.Concat(_0_s_k, Dafny.Sequence<Dafny.Rune>.FromElements(Utils.__default.shift__minus32((s).Select(_1_i))));
        } else {
          _0_s_k = Dafny.Sequence<Dafny.Rune>.Concat(_0_s_k, Dafny.Sequence<Dafny.Rune>.FromElements((s).Select(_1_i)));
        }
      }
      v = _0_s_k;
      return v;
    ...
    public static Dafny.Rune digit__to__char(BigInteger n) {
      return Dafny.Helpers.AddRunes(new Dafny.Rune('0'), new Dafny.Rune((int)(n)));
    }
    public static Dafny.ISequence<Dafny.Rune> numbert__to__string(BigInteger n) {
      Dafny.ISequence<Dafny.Rune> _0___accumulator = Dafny.Sequence<Dafny.Rune>.FromElements();
    TAIL_CALL_START: ;
      if ((n) < (new BigInteger(10))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.FromElements(Utils.__default.digit__to__char(n)), _0___accumulator);
      } else {
        _0___accumulator = Dafny.Sequence<Dafny.Rune>.Concat(Dafny.Sequence<Dafny.Rune>.FromElements(Utils.__default.digit__to__char(Dafny.Helpers.EuclideanModulus(n, new BigInteger(10)))), _0___accumulator);
        BigInteger _in0 = Dafny.Helpers.EuclideanDivision(n, new BigInteger(10));
        n = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static Dafny.Rune Computedigit__to__char(BigInteger n)
    {
      Dafny.Rune result = new Dafny.Rune('D');
      result = Dafny.Helpers.AddRunes(new Dafny.Rune('0'), new Dafny.Rune((int)(n)));
      return result;
      return result;
    }
    public static Dafny.ISequence<Dafny.Rune> ConvertNumberToString(BigInteger n)
    {
      Dafny.ISequence<Dafny.Rune> r = Dafny.Sequence<Dafny.Rune>.Empty;
      if ((n) < (new BigInteger(10))) {
        Dafny.Rune _0_digit__to__char;
        Dafny.Rune _out0;
        _out0 = Utils.__default.Computedigit__to__char(n);
        _0_digit__to__char = _out0;
        r = Dafny.Sequence<Dafny.Rune>.FromElements(_0_digit__to__char);
      } else {
        Dafny.ISequence<Dafny.Rune> _1_numToChar;
        Dafny.ISequence<Dafny.Rune> _out1;
        _out1 = Utils.__default.ConvertNumberToString(Dafny.Helpers.EuclideanDivision(n, new BigInteger(10)));
        _1_numToChar = _out1;
        Dafny.Rune _2_digit__to__char;
        Dafny.Rune _out2;
        _out2 = Utils.__default.Computedigit__to__char(Dafny.Helpers.EuclideanModulus(n, new BigInteger(10)));
        _2_digit__to__char = _out2;
        r = Dafny.Sequence<Dafny.Rune>.Concat(_1_numToChar, Dafny.Sequence<Dafny.Rune>.FromElements(_2_digit__to__char));
      }
      return r;
    }
    public static BigInteger char__to__int(Dafny.Rune c) {
      return new BigInteger((c).Value);
    }
    public static byte char__to__byte(Dafny.Rune c) {
    ...
    public static Dafny.ISequence<BigInteger> StringToSeqInt(Dafny.ISequence<Dafny.Rune> s)
    {
    ...
    public static bool list__contains__string(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> list, Dafny.ISequence<Dafny.Rune> sub)
    {
    TAIL_CALL_START: ;
      if ((new BigInteger((list).Count)).Sign == 0) {
        ...
        Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _in0 = (list).Drop(BigInteger.One);
    ...
    public static bool ContainsChar(Dafny.ISequence<Dafny.Rune> s, Dafny.Rune c)
    {
      return (s).Contains(c);
    }
    public static bool non__empty__string(Dafny.ISequence<Dafny.Rune> s) {
      return ((new BigInteger((s).Count)).Sign == 1) && (!(s).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")));
    }
    public static bool HasNoReservedNames(Dafny.ISequence<Dafny.Rune> path)
    {
      bool isValid = false;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _0_reservedNames;
      _0_reservedNames = Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("CON"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("PRN"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("AUX"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("NUL"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM1"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM2"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM3"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM4"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT1"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT2"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT3"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT4"));
      Dafny.ISequence<Dafny.Rune> _1_upperPath;
      ...
      for (BigInteger _2_i = BigInteger.Zero; _2_i < _hi0; _2_i++) {
        ...
        bool _out1;
        _out1 = Utils.__default.StartsWith(_1_upperPath, Dafny.Sequence<Dafny.Rune>.Concat((_0_reservedNames).Select(_2_i), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".")));
    ...
    public static bool StartsWith(Dafny.ISequence<Dafny.Rune> s, Dafny.ISequence<Dafny.Rune> prefix)
    {
      bool result = false;
    ...
    public static bool contains__consecutive__periods(Dafny.ISequence<Dafny.Rune> s) {
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)) < (new BigInteger(2))) {
        return false;
      } else if ((((s).Select(BigInteger.Zero)) == (new Dafny.Rune('.'))) && (((s).Select(BigInteger.One)) == (new Dafny.Rune('.')))) {
        return true;
      } else {
    ...
    public static bool has__dot__dot__slash(Dafny.ISequence<Dafny.Rune> path) {
      if ((new BigInteger((path).Count)) < (new BigInteger(3))) {
        return false;
      } else {
        return (((((path).Select(BigInteger.Zero)) == (new Dafny.Rune('.'))) && (((path).Select(BigInteger.One)) == (new Dafny.Rune('.')))) && (((path).Select(new BigInteger(2))) == (new Dafny.Rune('/')))) || (Utils.__default.has__dot__dot__slash((path).Drop(BigInteger.One)));
      }
    }
    public static bool ContainsDotDotForwardSlash(Dafny.ISequence<Dafny.Rune> path)
    {
      bool contains = false;
      contains = Utils.__default.has__dot__dot__slash(path);
      return contains;
    }
    public static bool has__dot__dot__backslash(Dafny.ISequence<Dafny.Rune> path) {
      if ((new BigInteger((path).Count)) < (new BigInteger(3))) {
        return false;
      } else {
        return (((((path).Select(BigInteger.Zero)) == (new Dafny.Rune('.'))) && (((path).Select(BigInteger.One)) == (new Dafny.Rune('.')))) && (((path).Select(new BigInteger(2))) == (new Dafny.Rune('\\')))) || (Utils.__default.has__dot__dot__backslash((path).Drop(BigInteger.One)));
      }
    }
    public static bool ContainsDotDotBackslash(Dafny.ISequence<Dafny.Rune> path)
    {
      bool contains = false;
      contains = Utils.__default.has__dot__dot__backslash(path);
      return contains;
    }
    public static bool has__slash__dot__dot(Dafny.ISequence<Dafny.Rune> path) {
      if ((new BigInteger((path).Count)) < (new BigInteger(3))) {
        return false;
      } else {
        return (((((path).Select(BigInteger.Zero)) == (new Dafny.Rune('/'))) && (((path).Select(BigInteger.One)) == (new Dafny.Rune('.')))) && (((path).Select(new BigInteger(2))) == (new Dafny.Rune('.')))) || (Utils.__default.has__slash__dot__dot((path).Drop(BigInteger.One)));
      }
    }
    public static bool ContainsSlashDotDot(Dafny.ISequence<Dafny.Rune> path)
    {
      bool contains = false;
      contains = Utils.__default.has__slash__dot__dot(path);
      return contains;
    }
    public static bool has__backslash__dot__dot(Dafny.ISequence<Dafny.Rune> path) {
      if ((new BigInteger((path).Count)) < (new BigInteger(3))) {
        return false;
      } else {
        return (((((path).Select(BigInteger.Zero)) == (new Dafny.Rune('\\'))) && (((path).Select(BigInteger.One)) == (new Dafny.Rune('.')))) && (((path).Select(new BigInteger(2))) == (new Dafny.Rune('.')))) || (Utils.__default.has__backslash__dot__dot((path).Drop(BigInteger.One)));
      }
    }
    public static bool ContainsBackslashDotDot(Dafny.ISequence<Dafny.Rune> path)
    {
      bool contains = false;
      contains = Utils.__default.has__backslash__dot__dot(path);
      return contains;
    }
    public static bool contains__encoded__periods(Dafny.ISequence<Dafny.Rune> s) {
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)) < (new BigInteger(4))) {
        return false;
      } else if ((((((s).Select(BigInteger.Zero)) == (new Dafny.Rune('%'))) && (((s).Select(BigInteger.One)) == (new Dafny.Rune('2')))) && (((s).Select(new BigInteger(2))) == (new Dafny.Rune('e')))) && (((s).Select(new BigInteger(3))) == (new Dafny.Rune('e')))) {
        return true;
      } else {
        Dafny.ISequence<Dafny.Rune> _in0 = (s).Drop(BigInteger.One);
        s = _in0;
    ...
    public static bool has__parent__dir__traversal(Dafny.ISequence<Dafny.Rune> s) {
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)) < (new BigInteger(2))) {
        return false;
      } else if ((((s).Select(BigInteger.Zero)) == (new Dafny.Rune('.'))) && (((s).Select(BigInteger.One)) == (new Dafny.Rune('.')))) {
    ...
    public static bool has__home__dir__reference(Dafny.ISequence<Dafny.Rune> s) {
    TAIL_CALL_START: ;
    ...
    public static bool has__consecutive__dots(Dafny.ISequence<Dafny.Rune> path) {
      if ((new BigInteger((path).Count)) < (new BigInteger(2))) {
        return false;
      } else {
        return ((((path).Select(BigInteger.Zero)) == (new Dafny.Rune('.'))) && (((path).Select(BigInteger.One)) == (new Dafny.Rune('.')))) || (Utils.__default.has__consecutive__dots((path).Drop(BigInteger.One)));
      }
    }
    public static bool contains__drive__letter(Dafny.ISequence<Dafny.Rune> s) {
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)) < (BigInteger.One)) {
        return false;
      } else if (((s).Select(BigInteger.Zero)) == (new Dafny.Rune(':'))) {
    ...
    public static bool contains__dangerous__pattern(Dafny.ISequence<Dafny.Rune> s) {
      return ((Utils.__default.has__parent__dir__traversal(s)) || (Utils.__default.has__home__dir__reference(s))) || (Utils.__default.contains__drive__letter(s));
    }
    public static bool base__includes__path(Dafny.ISequence<Dafny.Rune> filePath, Dafny.ISequence<Dafny.Rune> @base)
    {
    ...
    public static void SplitPath(Dafny.ISequence<Dafny.Rune> path, out Dafny.ISequence<Dafny.Rune> head, out Dafny.ISequence<Dafny.Rune> tail)
    {
      ...
      BigInteger _out0;
      _out0 = Utils.__default.LastSlash(path);
      _0_slashIdx = _out0;
    ...
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> SplitAll(Dafny.ISequence<Dafny.Rune> path)
    {
      ...
      Dafny.ISequence<Dafny.Rune> _out0;
      Dafny.ISequence<Dafny.Rune> _out1;
      Utils.__default.SplitPath(path, out _out0, out _out1);
      _0_head = _out0;
      _1_tail = _out1;
      if (((_0_head).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString(""))) && ((_1_tail).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("")))) {
        ...
        _out2 = Utils.__default.SplitAll((path).Take((new BigInteger((path).Count)) - (BigInteger.One)));
        parts = _out2;
      } else {
        ...
        _out3 = Utils.__default.SplitAll((_0_head).Take((new BigInteger((_0_head).Count)) - (BigInteger.One)));
    ...
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> SplitAllWithSlashes(Dafny.ISequence<Dafny.Rune> path)
    {
      ...
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _3_remainingParts;
      Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> _out2;
      _out2 = Utils.__default.SplitAllWithSlashes((_0_head).Take((new BigInteger((_0_head).Count)) - (BigInteger.One)));
    ...
    public static bool IsPrefix(Dafny.ISequence<Dafny.Rune> pre, Dafny.ISequence<Dafny.Rune> str)
    {
      ...
      while ((_0_i) < (new BigInteger((pre).Count))) {
        if (((str).Select(_0_i)) != ((pre).Select(_0_i))) {
          Dafny.Helpers.Print(((str).Select(_0_i)));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" != ")).ToVerbatimString(false));
          Dafny.Helpers.Print(((pre).Select(_0_i)));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
          res = false;
          return res;
        } else {
    ...
    public static bool IsSubstring(Dafny.ISequence<Dafny.Rune> sub, Dafny.ISequence<Dafny.Rune> str)
    {
      ...
      _0_i = BigInteger.Zero;
      BigInteger _1_n;
      _1_n = (new BigInteger((str).Count)) - (new BigInteger((sub).Count));
      while ((_0_i) < ((_1_n) + (BigInteger.One))) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        Dafny.Helpers.Print((sub).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", ")).ToVerbatimString(false));
        Dafny.Helpers.Print(((str).Subsequence(_0_i, new BigInteger((str).Count))).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        bool _2_result;
        bool _out0;
        _out0 = Utils.__default.IsPrefix(sub, (str).Subsequence(_0_i, new BigInteger((str).Count)));
        _2_result = _out0;
        if ((_2_result) == (true)) {
          res = true;
          return res;
    ...
    public static bool HaveCommonKSubstring(BigInteger k, Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      ...
      _0_i = BigInteger.Zero;
      BigInteger _1_n;
      _1_n = (new BigInteger((str1).Count)) - (k);
      while ((_0_i) < (_1_n)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        Dafny.Helpers.Print(((str1).Subsequence(_0_i, (_0_i) + (k))).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", ")).ToVerbatimString(false));
        Dafny.Helpers.Print((str2).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        bool _2_result;
        bool _out0;
        _out0 = Utils.__default.IsSubstring((str1).Subsequence(_0_i, (_0_i) + (k)), str2);
        _2_result = _out0;
        if ((_2_result) == (true)) {
          found = true;
          return found;
    ...
    public static BigInteger MaxCommonSubstringLength(Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      ...
      bool _0_result = false;
      BigInteger _1_i;
      _1_i = new BigInteger((str1).Count);
      if ((new BigInteger((str2).Count)) < (new BigInteger((str1).Count))) {
        _1_i = new BigInteger((str2).Count);
      }
      while ((_1_i).Sign == 1) {
        Dafny.Helpers.Print((str1).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(", ")).ToVerbatimString(false));
        Dafny.Helpers.Print((str2).ToVerbatimString(false));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" k = ")).ToVerbatimString(false));
        Dafny.Helpers.Print((_1_i));
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
        bool _out0;
        _out0 = Utils.__default.HaveCommonKSubstring(_1_i, str1, str2);
        _0_result = _out0;
        if ((_0_result) == (true)) {
          len = _1_i;
          return len;
    ...
    public static BigInteger LastCharIndex(Dafny.ISequence<Dafny.Rune> s, Dafny.Rune c)
    {
      BigInteger idx = BigInteger.Zero;
      idx = new BigInteger(-1);
      BigInteger _0_i;
    ...
    public static Dafny.ISet<Dafny.Rune> validPathCharacters { get {
      return Dafny.Set<Dafny.Rune>.FromElements(new Dafny.Rune('~'), new Dafny.Rune('-'), new Dafny.Rune('_'), new Dafny.Rune('.'), new Dafny.Rune('('), new Dafny.Rune(')'), new Dafny.Rune(' '), new Dafny.Rune('%'), new Dafny.Rune('/'));
    } }
    public static Dafny.ISet<Dafny.Rune> validFileCharacters { get {
      return Dafny.Set<Dafny.Rune>.FromElements(new Dafny.Rune('-'), new Dafny.Rune('_'), new Dafny.Rune('.'), new Dafny.Rune('('), new Dafny.Rune(')'), new Dafny.Rune(' '), new Dafny.Rune('%'));
    } }
    public static Dafny.ISet<Dafny.Rune> validStringCharacters { get {
      return Dafny.Set<Dafny.Rune>.FromElements(new Dafny.Rune(' '), new Dafny.Rune('~'), new Dafny.Rune('-'), new Dafny.Rune('_'), new Dafny.Rune('.'), new Dafny.Rune('('), new Dafny.Rune(')'), new Dafny.Rune(' '), new Dafny.Rune('%'), new Dafny.Rune('/'), new Dafny.Rune('!'), new Dafny.Rune('@'), new Dafny.Rune('#'), new Dafny.Rune('$'), new Dafny.Rune('^'), new Dafny.Rune('&'), new Dafny.Rune('*'), new Dafny.Rune('+'), new Dafny.Rune('='), new Dafny.Rune('|'), new Dafny.Rune('\\'), new Dafny.Rune(':'), new Dafny.Rune(';'), new Dafny.Rune(','), new Dafny.Rune('?'), new Dafny.Rune('<'), new Dafny.Rune('>'), new Dafny.Rune('['), new Dafny.Rune(']'), new Dafny.Rune('{'), new Dafny.Rune('}'), new Dafny.Rune('\''), new Dafny.Rune(' '), new Dafny.Rune('\t'), new Dafny.Rune('\n'), new Dafny.Rune('\r'));
    } }
    ...
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> restrictedDirs { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("etc/"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/root/"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/var/"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("C:\\Windows\\System32"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("C:\\Program Files"));
    } }
    public static BigInteger fileMinLength { get {
      return new BigInteger(4);
    } }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> invalidFileTypes { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("php"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("CON"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("PRN"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("AUX"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("NUL"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM1"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM2"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM3"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("COM4"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT1"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT2"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT3"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT4"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT5"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT6"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT7"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT8"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("LPT9"));
    } }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> currWDir { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/Users/pari/pcc-llms/src/playground"));
    } }
    public static Dafny.IMap<Dafny.ISequence<Dafny.Rune>,Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>> allowedServices { get {
      return Dafny.Map<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>.FromElements(new Dafny.Pair<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("apache"), Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("access.log"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("error.log"))), new Dafny.Pair<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("mysql"), Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("query.log"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("slow.log"))), new Dafny.Pair<Dafny.ISequence<Dafny.Rune>, Dafny.ISequence<Dafny.ISequence<Dafny.Rune>>>(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ssh"), Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("auth.log"))));
    } }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> sensitiveFiles { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/etc/passwd"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/etc/shadow"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/etc/hosts"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("C:\\Windows\\System32\\config\\SAM"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("C:\\Windows\\System32\\drivers\\etc\\hosts"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".ssh/id_rsa"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString(".ssh/id_rsa.pub"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("C:\\ProgramData\\Microsoft\\Windows\\Start Menu"));
    } }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> allowedExtensionsForRead { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("txt"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("pdf"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("docx"));
    } }
    public static Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> allowedExtensionsForWrite { get {
      return Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.FromElements(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("txt"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("docx"));
    } }
  }
  ...
  public interface _IPathOrFile {
    bool is_Path { get; }
    bool is_File { get; }
    Dafny.ISequence<Dafny.Rune> dtor_p { get; }
    Dafny.ISequence<Dafny.Rune> dtor_f { get; }
    _IPathOrFile DowncastClone();
  }
  public abstract class PathOrFile : _IPathOrFile {
    public PathOrFile() {
    }
    private static readonly Utils._IPathOrFile theDefault = create_Path(Dafny.Sequence<Dafny.Rune>.Empty);
    ...
    public static _IPathOrFile create_Path(Dafny.ISequence<Dafny.Rune> p) {
      return new PathOrFile_Path(p);
    }
    public static _IPathOrFile create_File(Dafny.ISequence<Dafny.Rune> f) {
    ...
    public Dafny.ISequence<Dafny.Rune> dtor_p {
      get {
        var d = this;
        return ((PathOrFile_Path)d)._p;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_f {
      get {
        var d = this;
  ...
  public class PathOrFile_Path : PathOrFile {
    public readonly Dafny.ISequence<Dafny.Rune> _p;
    public PathOrFile_Path(Dafny.ISequence<Dafny.Rune> p) : base() {
      this._p = p;
    }
    ...
    public override string ToString() {
      ...
      s += "(";
      s += this._p.ToVerbatimString(true);
      s += ")";
      return s;
    }
  }
  public class PathOrFile_File : PathOrFile {
    public readonly Dafny.ISequence<Dafny.Rune> _f;
    public PathOrFile_File(Dafny.ISequence<Dafny.Rune> f) : base() {
      this._f = f;
    }
    public override _IPathOrFile DowncastClone() {
      if (this is _IPathOrFile dt) { return dt; }
    ...
    public override string ToString() {
      ...
      s += "(";
      s += this._f.ToVerbatimString(true);
      s += ")";
      return s;
    }
  }
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static bool isSubstring(Dafny.ISequence<Dafny.Rune> sub, Dafny.ISequence<Dafny.Rune> str)
    {
      ...
      BigInteger _0_i;
      _0_i = (new BigInteger((str).Count)) - (new BigInteger((sub).Count));
      while ((_0_i).Sign != -1) {
        bool _1_isPref;
        bool _out0;
    ...
    public static bool haveCommonKSubstring(BigInteger k, Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      ...
      BigInteger _0_i;
      _0_i = (new BigInteger((str1).Count)) - (k);
      while ((_0_i).Sign != -1) {
        BigInteger _1_t;
        _1_t = (_0_i) + (k);
        bool _2_isSub;
        bool _out0;
        _out0 = __default.isSubstring((str1).Subsequence(_0_i, _1_t), str2);
        _2_isSub = _out0;
        if (_2_isSub) {
          found = true;
          return found;
    ...
    public static BigInteger maxCommonSubstringLength(Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      BigInteger len = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = new BigInteger((str1).Count);
      while ((_0_i).Sign == 1) {
        bool _1_ans;
        bool _out0;
        _out0 = __default.haveCommonKSubstring(_0_i, str1, str2);
        _1_ans = _out0;
        if (_1_ans) {
          len = _0_i;
          return len;
    ...
    public static bool HaveCommonKSubstring(BigInteger k, Dafny.ISequence<Dafny.Rune> str1, Dafny.ISequence<Dafny.Rune> str2)
    {
      ...
      while ((_0_i) < (_1_n)) {
        ...
        bool _2_result;
        bool _out0;
        _out0 = __default.isSubstring((str1).Subsequence(_0_i, (_0_i) + (k)), str2);
        _2_result = _out0;
        if ((_2_result) == (true)) {
          found = true;
          return found;
    ...
    {
      Dafny.ISequence<Dafny.Rune> _0_dir;
      _0_dir = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/usr/bin/python");
      Dafny.ISequence<Dafny.Rune> _1_prefix;
      _1_prefix = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/usr");
      bool _2_res;
      bool _out0;
      _out0 = Utils.__default.IsSubstring(_1_prefix, _0_dir);
      _2_res = _out0;
      if (!(_2_res)) {
        throw new Dafny.HaltException("/Users/pari/pcc-llms/tests/interface-test/test-string-helper.dfy(187,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/usr in /usr/bin/python").ToVerbatimString(false));}
      Dafny.ISequence<Dafny.Rune> _3_dir2;
      _3_dir2 = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/usr/bin/python");
      Dafny.ISequence<Dafny.Rune> _4_prefix2;
      _4_prefix2 = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/home");
      bool _5_res2;
      bool _out1;
      _out1 = Utils.__default.IsSubstring(_1_prefix, _3_dir2);
      _5_res2 = _out1;
      if (!(_5_res2)) {
        throw new Dafny.HaltException("/Users/pari/pcc-llms/tests/interface-test/test-string-helper.dfy(192,5): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/home in /usr/bin/python").ToVerbatimString(false));}
      Dafny.Helpers.Print((_5_res2));
      Dafny.ISequence<Dafny.Rune> _6_dir3;
      _6_dir3 = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/usr/bin/python");
      Dafny.ISequence<Dafny.Rune> _7_prefix3;
      _7_prefix3 = Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/bin");
      bool _8_res3;
      bool _out2;
      _out2 = Utils.__default.HaveCommonKSubstring(new BigInteger(4), _6_dir3, _7_prefix3);
      _8_res3 = _out2;
      if (!(_8_res3)) {
        throw new Dafny.HaltException("/Users/pari/pcc-llms/tests/interface-test/test-string-helper.dfy(199,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("res3").ToVerbatimString(false));}
    }
  }
