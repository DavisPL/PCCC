// Dafny program fileiotest.dfy compiled into C#
...
// Command Line Options: fileiotest.dfy fileionative.cs
// fileiotest.dfy
...
class FileStream {
  ...
  function {:extern} Name(): string
    reads this
    decreases {this}

  function {:extern} IsOpen(): bool
    reads this
    decreases {this}
  ...
  method {:extern} Read(fileOffset: nat32, buffer: array<byte>, start: int32, end: int32)
      returns (ok: bool)
    requires env.ok.ok()
    requires IsOpen()
    requires 0 <= start as int <= end as int <= buffer.Length
    modifies this, env.ok, buffer
    ensures env == old(env)
    ensures env.ok.ok() == ok
    ensures Name() == old(Name())
    ensures forall i: int {:trigger old(buffer[i])} {:trigger buffer[i]} :: 0 <= i < buffer.Length && !(start as int <= i < end as int) ==> buffer[i] == old(buffer[i])
    ensures ok ==> IsOpen()
    decreases fileOffset, buffer, start, end

  method {:extern} Write(fileOffset: nat32, buffer: array<byte>, start: int32, end: int32)
      returns (ok: bool)
    requires env.ok.ok()
    requires IsOpen()
    requires 0 <= start as int <= end as int <= buffer.Length
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Dafny.Rune[] _0_fname;
      Dafny.Rune[] _out0;
      _out0 = __default.ArrayFromSeq<Dafny.Rune>(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("foo.txt"));
      _0_fname = _out0;
      FileStream _1_f = default(FileStream);
      bool _2_ok = false;
      bool _out1;
      FileStream _out2;
      FileStream.Open(_0_fname, out _out1, out _out2);
      _2_ok = _out1;
      _1_f = _out2;
      if (!(_2_ok)) {
        Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("open failed\n")).ToVerbatimString(false));
        return ;
      }
      byte[] _3_data;
      byte[] _out3;
      _out3 = __default.ArrayFromSeq<byte>(Dafny.Sequence<byte>.FromElements((byte)(104), (byte)(101), (byte)(108), (byte)(108), (byte)(111), (byte)(32), (byte)(119), (byte)(111), (byte)(114), (byte)(108), (byte)(100), (byte)(33), (byte)(10)));
      _3_data = _out3;
      bool _out4;
      _out4 = (_1_f).Write(0, _3_data, 0, (int)(_3_data).Length);
      _2_ok = _out4;
  ...
  public partial class nat32 {
    ...
    public static bool _Is(int __source) {
      BigInteger _4_i = new BigInteger(__source);
      return ((_4_i).Sign != -1) && ((_4_i) < (new BigInteger(2147483648L)));
    }
  }
