...
class default__:
    ...
    def Main(noArgsParameter__):
        ...
        out0_: _dafny.Array
        out0_ = default__.ArrayFromSeq(_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "file.txt")))
        d_2_fname_ = out0_
        ...
        d_4_ok_ = out4_
        if not(d_4_ok_):
            _dafny.print((_dafny.SeqWithoutIsStrInference(map(_dafny.CodePoint, "Write failed\n"))).VerbatimString(False))
            return
