...
class default__:
    ...
    def ConcatBytes(ts, fT):
        d_559___accumulator_ = _dafny.SeqWithoutIsStrInference([])
        while True:
            with _dafny.label():
                if (len(ts)) == (0):
                    return (d_559___accumulator_) + (_dafny.SeqWithoutIsStrInference([]))
                elif True:
                    d_559___accumulator_ = (d_559___accumulator_) + (fT((ts)[0]))
    ...
    @staticmethod
    def Object(obj):
        def lambda36_(d_560_obj_):
            def lambda37_(d_561_d_):
                return default__.Member(d_561_d_)
    ...
    @staticmethod
    def Array(arr):
        def lambda38_(d_562_arr_):
            def lambda39_(d_563_d_):
                return default__.Item(d_563_d_)
    ...
    def Value(self):
        ...
        if source22_.is_Null:
            d_564___mcc_h0_ = source22_.n
            d_565_n_ = d_564___mcc_h0_
            return default__.View(d_565_n_)
        elif source22_.is_Bool:
            d_566___mcc_h1_ = source22_.b
            d_567_b_ = d_566___mcc_h1_
            return default__.View(d_567_b_)
        elif source22_.is_String:
            d_568___mcc_h2_ = source22_.str
            d_569_str_ = d_568___mcc_h2_
            return default__.String(d_569_str_)
        elif source22_.is_Number:
            d_570___mcc_h3_ = source22_.num
            d_571_num_ = d_570___mcc_h3_
            return default__.Number(d_571_num_)
        elif source22_.is_Object:
            d_572___mcc_h4_ = source22_.obj
            d_573_obj_ = d_572___mcc_h4_
            return default__.Object(d_573_obj_)
        elif True:
            d_574___mcc_h5_ = source22_.arr
            d_575_arr_ = d_574___mcc_h5_
            return default__.Array(d_575_arr_)
