// Dafny program ReadBytesFile.dfy compiled into C#
...
// Command-line arguments: run ReadBytesFile.dfy --no-verify --unicode-char false --target cs --input FileIO.cs -- input.txt System.ArgumentException:
// ReadBytesFile.dfy
...
module ReadBytesFromFile {
  method {:test} Test()
  {
    theMain(""/Users/pari/pcc-llms/filesystems-api/Standard-fileIO/input.txt"", """");
  }
...
namespace ReadBytesFromFile {
  ...
  public partial class __default {
    ...
    {
      ReadBytesFromFile.__default.theMain(Dafny.Sequence<char>.FromString("/Users/pari/pcc-llms/filesystems-api/Standard-fileIO/input.txt"), Dafny.Sequence<char>.FromString(""));
    }
    public static void theMain(Dafny.ISequence<char> dataPath, Dafny.ISequence<char> expectedErrorPrefix)
    {
      {
        Dafny.ISequence<char> _0_expectedStr;
        _0_expectedStr = Dafny.Sequence<char>.FromString("Hello world");
        Dafny.ISequence<BigInteger> _1_expectedBytes;
        _1_expectedBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim0 = new BigInteger((_0_expectedStr).Count);
          var arr0 = new BigInteger[Dafny.Helpers.ToIntChecked(dim0, "array size exceeds memory limit")];
          for (int i0 = 0; i0 < dim0; i0++) {
            var _2_i = (BigInteger) i0;
            arr0[(int)(_2_i)] = new BigInteger((_0_expectedStr).Select(_2_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr0);
        }))();
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _3_res;
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _out0;
        _out0 = FileIO.__default.ReadBytesFromFile(dataPath);
        _3_res = _out0;
        if (!((_3_res).is_Success)) {
          throw new Dafny.HaltException("ReadBytesFile.dfy(23,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_3_res).dtor_error));}
        Dafny.ISequence<BigInteger> _4_readBytes;
        _4_readBytes = ((System.Func<Dafny.ISequence<BigInteger>>) (() => {
          BigInteger dim1 = new BigInteger(((_3_res).dtor_value).Count);
          var arr1 = new BigInteger[Dafny.Helpers.ToIntChecked(dim1, "array size exceeds memory limit")];
          for (int i1 = 0; i1 < dim1; i1++) {
            var _5_i = (BigInteger) i1;
            arr1[(int)(_5_i)] = new BigInteger(((_3_res).dtor_value).Select(_5_i));
          }
          return Dafny.Sequence<BigInteger>.FromArray(arr1);
        }))();
        if (!((_4_readBytes).Equals(_1_expectedBytes))) {
          throw new Dafny.HaltException("ReadBytesFile.dfy(26,6): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));}
      }
      {
        Wrappers._IResult<Dafny.ISequence<byte>, Dafny.ISequence<char>> _6_res;
        ...
        if (!((_6_res).is_Failure)) {
          throw new Dafny.HaltException("ReadBytesFile.dfy(32,6): " + Dafny.Sequence<char>.FromString("unexpected success"));}
        if (!(Dafny.Sequence<char>.IsPrefixOf(expectedErrorPrefix, (_6_res).dtor_error))) {
          throw new Dafny.HaltException("ReadBytesFile.dfy(33,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_6_res).dtor_error));}
      }
    }
  }
