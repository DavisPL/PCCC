...
// Command-line arguments: run /Users/pari/pcc-llms/FilesystemsAPI/std/tests/read/ReadBytes.dfy --no-verify --unicode-char false --target cs --input /Users/pari/pcc-llms/FilesystemsAPI/std/FileIO.cs -- /Users/pari/pcc-llms/FilesystemsAPI/std/tests/read/data.txt System.ArgumentException:
// ReadBytes.dfy
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> args)
    {
      if (!((new BigInteger((args).Count)).Sign == 1)) {
        throw new Dafny.HaltException("tests/read/ReadBytes.dfy(18,4): " + Dafny.Sequence<char>.FromString("expectation violation"));}
      if (!((new BigInteger((args).Count)) == (new BigInteger(3)))) {
        throw new Dafny.HaltException("tests/read/ReadBytes.dfy(19,4): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("usage: "), (args).Select(BigInteger.Zero)), Dafny.Sequence<char>.FromString(" DATA_PATH EXPECTED_ERROR_PREFIX")));}
      ...
      _1_expectedErrorPrefix = (args).Select(new BigInteger(2));
      {
        ...
        if (!((_5_res).is_Success)) {
          throw new Dafny.HaltException("tests/read/ReadBytes.dfy(30,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected failure: "), (_5_res).dtor_error));}
        ...
        if (!((_6_readBytes).Equals(_3_expectedBytes))) {
          throw new Dafny.HaltException("tests/read/ReadBytes.dfy(33,6): " + Dafny.Sequence<char>.FromString("read unexpected byte sequence"));}
      }
      {
        ...
        if (!((_8_res).is_Failure)) {
          throw new Dafny.HaltException("tests/read/ReadBytes.dfy(39,6): " + Dafny.Sequence<char>.FromString("unexpected success"));}
        if (!(Dafny.Sequence<char>.IsPrefixOf(_1_expectedErrorPrefix, (_8_res).dtor_error))) {
          throw new Dafny.HaltException("tests/read/ReadBytes.dfy(40,6): " + Dafny.Sequence<char>.Concat(Dafny.Sequence<char>.FromString("unexpected error message: "), (_8_res).dtor_error));}
      }
    }
  }
